...
import org.eclipse.emf.codegen.jet.*;
...
public class PPackage implements CodeTemplate {
    ...
    private Config config = new Config();
	   ...
	   */
	  protected void finishPage(IProgressMonitor monitor, IPath root) 
	  throws InterruptedException, CoreException
	  {
//	    config.setModel(mPage1.getTypesafeEnumModel());
	    config.setPackageName("mvc");
	    config.setTargetFile("View" + ".java");
	    config.setTargetFolder(root + "/src");

	    config.setClasspathVariable("ARCHIMATE");
	    config.setPluginId(pluginId);
	    config.setTemplateRelativeUri("src/archimate/patterns/mvc/ControlCommandPort.javajet");
	    
		MVCTest typesafe = new MVCTest();
//		typesafe.setAuthor("Samuel");
//		typesafe.setClassName("View");
//		typesafe.setPackageName("mvc");
//		Attribute attr = new Attribute();
//		attr.setName("test");
//		attr.setType("int");
//		attr.setKey(true);
//		typesafe.addAttribute(attr);
//		Instance inst = new Instance();
//		typesafe.addInstance(inst);
//		inst.setName("test_instance");
//		Properties prop = new Properties();
//		prop.setProperty("test", "1");
//		inst.setValues(prop);
//		inst.setDefault();
		
		config.setModel(typesafe);

//	    JETGateway gateway = new JETGateway(config);
	    String content = generate(monitor);
	    IFile file = null;
		try {
			file = save(monitor, content.getBytes());
